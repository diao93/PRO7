...
data_test = pd.read_csv('C:/Users/diall/OneDrive/Bureau/Openclassroom/Projet 7/test_df_sample.csv')
...
# Sidebar
with st.sidebar:
    logo = Image.open('C:/Users/diall/OneDrive/Bureau/Openclassroom/Projet 7/img/logo pret à dépenser.png')
