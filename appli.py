...
with open('C:/Users/diall/OneDrive/Bureau/Openclassroom/Projet 7/model.pkl', 'rb') as file:
    model = pickle.load(file)
data = pd.read_csv('C:/Users/diall/OneDrive/Bureau/Openclassroom/Projet 7/test_df_sample.csv')
data_train = pd.read_csv('C:/Users/diall/OneDrive/Bureau/Openclassroom/Projet 7/train_df_sample.csv')
...
def get_prediction(client_id: int):
    ...
    prediction = classifier.predict_proba(info_client)[0][1]
    return prediction
